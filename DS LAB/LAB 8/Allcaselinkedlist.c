// Allcaselinkedlist.c
//Write a menu driven program to implement following operations on Single Linked List:​
//-insert() – (beginning, middle, last)​
//-delete() – (beginning, middle, last)​
//-display()
...
/////////////////////////////////   **Beg Insertion**   ///////////////////////////////////
struct node *beg_insertion(struct node *ptr)
{
    int data;
    printf("\nEnter the data: ");
    scanf("%d", &data);
